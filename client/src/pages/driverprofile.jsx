        ...
        <div className="bg-opacity-80 bg-gray-800 p-8 rounded-xl shadow-lg max-w-3xl w-full">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
             ...
             {/* Username Field */}
             <div className="flex-1">
                <label htmlFor="tel" className="block text-sm font-medium text-gray-300">
                  telephone
                </label>
                <input
                  type="text"
            ...
            <div>
             ...
             {/* Username Field */}
             <div className="flex-1">
                <label htmlFor="licences" className="block text-sm font-medium text-gray-300">
                Licences
                </label>
                <input
                  type="text"
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="seat" className="block text-sm font-medium text-gray-300">
              Seat
              </label>
              <input
                type="text"
             ...
             {/* Username Field */}
             <div className="flex-1">
                <label htmlFor="userrole" className="block text-sm font-medium text-gray-300">
                User Role
                </label>
                <input
                  type="text"
